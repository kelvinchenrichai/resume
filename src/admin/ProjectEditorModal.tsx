  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await onSave({
        ...
        displayOrder: Number(form.get('displayOrder')) || 1, featuredOrder: Number(form.get('featuredOrder')) || Number(form.get('displayOrder')) || 1, updatedAt: new Date().toISOString(),
      });
      onClose();
    } catch (err) {
